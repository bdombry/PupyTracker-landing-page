...
export default function EducationSection() {
  return (
    <section id="conseils" className="py-24 bg-gradient-to-b from-[#BFDBFE]/30 to-[#F5F5F5]">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-[#3B82F6]/70 text-lg">
              Nos conseils d'experts pour une éducation réussie et bienveillante
            </p>
          </motion.div>
          
          <motion.div
            className="bg-white rounded-3xl p-8 md:p-12 shadow-lg shadow-[#3B82F6]/5 border border-[#3B82F6]/20"
          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-[#3B82F6]/80 leading-relaxed mb-6">
                <strong className="text-[#3B82F6]">Éduquer un chiot à la propreté</strong> est une étape essentielle qui demande patience, constance et bienveillance. Chaque chiot apprend à son propre rythme, et il est important de ne jamais le punir pour un accident. Voici les principes fondamentaux pour réussir l'apprentissage de la propreté.
              </p>
              
              <h3 className="text-xl font-bold text-[#3B82F6] mt-8 mb-4 flex items-center gap-2">
                <span className="w-8 h-8 bg-[#3B82F6]/50 rounded-full flex items-center justify-center text-sm">1</span>
              ...
              <h3 className="text-xl font-bold text-[#3B82F6] mt-8 mb-4 flex items-center gap-2">
                <span className="w-8 h-8 bg-[#BFDBFE]/50 rounded-full flex items-center justify-center text-sm">2</span>
                Récompenser les bons comportements
              </h3>
              <p className="text-[#3B82F6]/80 leading-relaxed mb-6">
                Lorsque votre chiot fait ses besoins dehors, félicitez-le immédiatement avec enthousiasme et offrez-lui une petite friandise. Cette <strong className="text-[#3B82F6]">éducation positive</strong> renforce le comportement souhaité. Évitez absolument de le gronder pour les accidents – cela ne ferait que créer de la confusion et du stress.
              </p>
              
              <h3 className="text-xl font-bold text-[#3B82F6] mt-8 mb-4 flex items-center gap-2">
                <span className="w-8 h-8 bg-[#DBEAFE]/50 rounded-full flex items-center justify-center text-sm">3</span>
              ...
              <h3 className="text-xl font-bold text-[#3B82F6] mt-8 mb-4 flex items-center gap-2">
                <span className="w-8 h-8 bg-[#3B82F6]/50 rounded-full flex items-center justify-center text-sm">4</span>
                Gérer les accidents avec calme
              </h3>
              <p className="text-[#3B82F6]/80 leading-relaxed mb-6">
                Les accidents font partie de l'apprentissage et sont tout à fait normaux. Si vous surprenez votre chiot en train de faire à l'intérieur, interrompez-le doucement et emmenez-le rapidement dehors. Nettoyez ensuite avec un produit enzymatique pour éliminer les odeurs. <strong className="text-[#3B82F6]">Conseils éducation chiot</strong> : ne punissez jamais après coup, votre chiot ne ferait pas le lien.
              </p>
              
              <h3 className="text-xl font-bold text-[#3B82F6] mt-8 mb-4 flex items-center gap-2">
                <span className="w-8 h-8 bg-[#BFDBFE]/50 rounded-full flex items-center justify-center text-sm">5</span>
                Adapter selon l'âge
              </h3>
              <p className="text-[#3B82F6]/80 leading-relaxed">
            ...
            {/* CTA in article */}
            <div className="mt-10 p-6 bg-gradient-to-r from-[#3B82F6]/30 to-[#DBEAFE]/30 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="text-center md:text-left">
                <p className="text-[#3B82F6] font-semibold">
                  Envie de suivre les progrès de votre chiot ?
                </p>
                <p className="text-[#3B82F6]/70 text-sm">
                  Téléchargez PupyTracker et commencez dès aujourd'hui
                </p>
              </div>
              <motion.a
                href="#"
                className="bg-[#3B82F6] text-white px-6 py-3 rounded-xl font-semibold whitespace-nowrap hover:bg-[#2563EB] transition-colors"
