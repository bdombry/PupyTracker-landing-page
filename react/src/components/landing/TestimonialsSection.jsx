...
export default function TestimonialsSection() {
  return (
    <section id="temoignages" className="py-24 bg-[#FFF9F4]">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <span className="inline-block bg-[#BFD9FF]/50 text-[#A67C52] px-4 py-2 rounded-full text-sm font-medium mb-4">
            💬 Témoignages
          </span>
          ...
          <div className="flex items-center justify-center gap-3 mt-6">
            ...
            <span className="text-[#A67C52] font-bold text-xl">4.9/5</span>
            <span className="text-[#A67C52]/60">• +2 500 avis</span>
          </div>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <motion.div
              key={index}
              className={`${testimonial.color} rounded-3xl p-6 border border-[#A67C52]/10`}
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              {/* Text */}
              <p className="text-[#A67C52] mb-6 leading-relaxed">
                "{testimonial.text}"
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[#A67C52] font-semibold">{testimonial.name}</p>
                  <p className="text-[#A67C52]/60 text-sm">{testimonial.role}</p>
                </div>
              </div>
            </motion.div>
          ))}
